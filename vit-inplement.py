...
# from here i could learn that jpeg and png have different numbers of channel.
# plt image to see
# fig = plt.figure()
# plt.imshow(img)
# plt.show()
...
# this resizes images and changes them into 4 channels.
...
# [1, 4, 224, 224]
#%% create one Patch Embedding

# patch embedding is one simple neural network, and its function is to turn images into patches.
...
#%% train the ViT here to see if feasible.
...
for epoch in range(n_epoch):
    ...
    for batch in train_loader:
        ...
        print(f"Batch loss {loss.item():.2f}")
